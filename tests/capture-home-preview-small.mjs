...
for (const [selector, file] of [
  [".value-section-v2", "value-preview-small.jpg"],
  [".cases-section-v2", "cases-preview-small.jpg"],
]) {
  const section = page.locator(selector);
  await section.scrollIntoViewIfNeeded();
  await page.waitForTimeout(700);
  await section.screenshot({ path: `D:/07-workspace/website-namche/.history/${file}`, type: "jpeg", quality: 22 });
}
